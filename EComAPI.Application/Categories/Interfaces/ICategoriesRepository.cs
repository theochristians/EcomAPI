...
namespace EComAPI.Application.Categories.Interfaces
{
    public interface ICategoryRepository
    {
        ...
        Task<Domain.Categories.Entities.Category?> GetCategoryByIdAsync(Guid id, CancellationToken cancellationToken = default);
        Task<Domain.Categories.Entities.Category?> GetCategoryByIdIncludeDeletedAsync(Guid id, CancellationToken cancellationToken = default);
        Task<Domain.Categories.Entities.Category?> GetCategoryBySlugAsync(string slug, CancellationToken cancellationToken = default);
        Task<IReadOnlyList<Domain.Categories.Entities.Category>> GetAllCategoriesAsync(CancellationToken cancellationToken = default);
        Task AddCategoryAsync(Domain.Categories.Entities.Category categories, CancellationToken cancellationToken = default);
        Task UpdateCategoryAsync(Domain.Categories.Entities.Category categories, CancellationToken cancellationToken = default);
