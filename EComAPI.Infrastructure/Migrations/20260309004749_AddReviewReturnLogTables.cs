...
{
    /// <inheritdoc />
    public partial class AddReviewReturnLogTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnImages_Returns_ReturnId",
                        column: x => x.ReturnId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockLogs_ProductVariantId",
                table: "StockLogs",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_StockLogs_ReferenceId",
                table: "StockLogs",
                column: "ReferenceId");
        }
